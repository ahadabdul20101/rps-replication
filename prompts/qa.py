# prompts/qa.py
# Strategy: QA — Direct pick, no reasoning (paper's Fig. 4)
#
# Matches paper's Fig. 4 exactly:
#   - "You are currently playing round N." (no "of T")
#   - "Option J, Option F, or Option B" (keep "Option" word)
#   - Format spec: "Option: <J, F, or B>" (not bare letter)
